...
function RemovedEmployees(){
	...
	let deletingoff = (obj)=>{
		axios.delete("https://codejava-app-10-c2fa34a8f93d.herokuapp.com/deleteperminent", { data: obj });
	}
	useEffect(()=>{
		axios.get("https://codejava-app-10-c2fa34a8f93d.herokuapp.com/gettingdeleted")
		.then((response) => {

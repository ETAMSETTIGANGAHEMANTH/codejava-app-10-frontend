...
function Employees() {
  ...
  let saveuser = () =>{
	  ...
	  axios.post("https://codejava-app-10-c2fa34a8f93d.herokuapp.com/updating",modifyuser)
	.then((response) => {
  ...
  let deleteemployee = (deletingobject) =>{
	  axios.post("https://codejava-app-10-c2fa34a8f93d.herokuapp.com/inserting",deletingobject);
	  //axios.delete("http://localhost:8080/delete",deletingobject);
	  axios.delete("https://codejava-app-10-c2fa34a8f93d.herokuapp.com/delete", { data: deletingobject });
	  console.log("the object was deleted");
  }

  useEffect(() => {
    axios.get("https://codejava-app-10-c2fa34a8f93d.herokuapp.com/get")
      .then((response) => {
